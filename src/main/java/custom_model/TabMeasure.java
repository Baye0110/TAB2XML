...
//			}
			...
			if(isBend == true) {
				...
				String text = (currentNote.getNotation().getTechnical().getBend().getBendAlter() == 2) ? "full" : String.valueOf(currentNote.getNotation().getTechnical().getBend().getBendAlter()/2);
